            ...
            <div className="flex items-center justify-center w-full">
              <Tabs className="w-3/4" defaultValue="login">
                ...
                <TabsContent className="flex flex-col gap-5 mt-10" value="login">
                  ...
                  <Button variant={"mainBtn"} className="rounded-full p-6" onClick={handleLogin}>Login</Button>
                </TabsContent>
                <TabsContent className="flex flex-col gap-5" value="signup">
                  ...
                  <Button variant={"mainBtn"} className="rounded-full p-6" onClick={handleSignup}>Signup</Button>
                </TabsContent>
              </Tabs>
            </div>
          </div>
          <div className="hidden xl:flex justify-center items-center">
            <img src={mainImg} alt="Login page" className="ml-10 mr-2"/>
          </div>
        </div>
      </div>
    </>
